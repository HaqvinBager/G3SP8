...
CInGameState::CInGameState(CStateStack& aStateStack, const CStateStack::EState aState)
	...
	, myMenuCameraPositions({ Vector3(9.73f, -0.615f, -37.74f), Vector3(15.59f, -0.64f, -37.5f), Vector3(17.36f, -1.04f, -27.89f), Vector3(17.03f, -0.464f, -33.78f) })
	, myMenuCameraRotations({ Vector3(-1.098f, 91.25f, 0.789f), Vector3(0.0f, 85.221f, 0.0f) , Vector3(-20.59f, -30.739f, 0.119f) , Vector3(-1.614f, 80.0f, 1.018f) })
