...
enum class ESFX { Unused, Grab, Throw, LetGo, Unused1, EnemyHit, SwitchPress, PickupGravityGlove, PickupHeal, EnemyAttack, CardboardBox, MovePainting, DoorOpen, PhoneDead, Count };
