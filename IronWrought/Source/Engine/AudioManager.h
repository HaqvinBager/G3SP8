...
enum class EChannel { Music, Ambience, SFX, UI, VOX, DynamicChannel1, DynamicChannel2, DynamicChannel3, DynamicChannel4, Enemy2DChannel, Enemy2DChannel2, Count };
