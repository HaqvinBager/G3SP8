...
enum class ESFX { Unused, Grab, Throw, LetGo, Unused1, EnemyHit, SwitchPress, PickupGravityGlove, PickupHeal, EnemyAttack, CardboardBox, MovePainting, DoorOpen, PhoneDead, WoodImpactMedium, WoodImpactSmall, CeramicImpactLarge, CeramicImpactMedium, CeramicImpactSmall, PlasticImpact, PaperImpact, SilverwareImpact, AshtrayImpact, CanImpact, BookImpact, ToiletPaperRollImpact, CameraImpact, ViolinImpact, DoorRattle, PuzzleProgress, PuzzleSolved, PuzzleKey, Count };
