...
const Vector2& CSpotLight::GetInnerOuterAngle() const
{
	return myInnerOuterAngle;
}
...
const bool CSpotLight::GetIsVolumetric() const
{
...
void CSpotLight::SetInnerOuterAngle(const Vector2& aInnerOuterAngle)
{
	myInnerOuterAngle = aInnerOuterAngle;
}

void CSpotLight::SetIsVolumetric(const bool aIsVolumetric)
{
	myIsVolumetric = aIsVolumetric;
}
