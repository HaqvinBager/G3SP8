...
namespace FastNoise
{
    ...
    public:
        ...
        void SetValueIndex( int value ) { mValueIndex = min( max( value, 0 ), kMaxDistanceCount - 1 ); }
    ...
    public:
        ...
        void SetDistanceIndex0( int value ) { mDistanceIndex0 = min( max( value, 0 ), kMaxDistanceCount - 1 ); }
        void SetDistanceIndex1( int value ) { mDistanceIndex1 = min( max( value, 0 ), kMaxDistanceCount - 1 ); }
