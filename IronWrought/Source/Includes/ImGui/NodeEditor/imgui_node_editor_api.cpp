...
bool ax::NodeEditor::AcceptUndo()
{
    return s_Editor->GetShortcut().AcceptUndo();
}

bool ax::NodeEditor::AcceptRedo()
{
    return s_Editor->GetShortcut().AcceptRedo();
}

void ax::NodeEditor::ResetShortCutAction()
{
    s_Editor->ResetShortCutAction();
    //IsActive()
}
